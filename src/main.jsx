  ...
  return (
    <div className="appShell">
      <aside className="sidebar">
        <div className="brand">
          <img src={logo} alt="MF Elétrica e Solar" />
      ...
      <main className="main">
        <header className="hero">
          <div><span className="eyebrow"><Zap size={16} /> Sistema operacional premium</span><h1>MF Elétrica e Solar</h1><p>Controle de alertas, clientes, agenda técnica e relatórios com banco de dados online.</p></div>
